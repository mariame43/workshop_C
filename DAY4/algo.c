...
struct joueur joueurs[100] = { 
    ...
    {4, 1, 27, 0, "soufiane", "mourabit", "Gardien", "Titulaire"},
    {5, 11, 23, 12, "yassine", "bono", "Attaquant", "Titulaire"},
     {6, 10, 22, 15, "azedine", "ounahi", "Attaquant", "Titulaire"},
    {7, 5, 25, 5, "yousef", "nasiri", "Défenseur", "Titulaire"},
...
void Statistiques(){
    int choix4;
      ...
      printf("5.Afficher le joueur le plus jeune et le plus âgé.\n");
        ...
        int minIndex = 0, maxIndex = 0;    //Pour stocker (es indices des joueurs avec l'âge 
    for (int i = 1; i < nbjoueurs; i++) {
